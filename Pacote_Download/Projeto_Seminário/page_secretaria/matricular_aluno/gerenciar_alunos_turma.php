...
if (isset($_POST['turma_selecionada'])) {
    ...
    $alunos_sql = "SELECT a.id_aluno, a.aluno_nome_completo, a.aluno_cpf, m.id_matricula 
                   FROM aluno a 
        ...
        <table class="table">
            ...
            <tbody>
                <?php while ($aluno = mysqli_fetch_assoc($alunos_matriculados)) : ?>
                    <tr>
                        <td><?= $aluno['aluno_nome_completo'] ?></td>
                        <td><?= $aluno['aluno_cpf'] ?></td>
                        <td>
                            <form method="POST" action="" style="display:inline;">
                                <input type="hidden" name="id_matricula" value="<?= $aluno['id_matricula'] ?>">
